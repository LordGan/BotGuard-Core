...
1.  **Local Processing**: All data captured by BotGuard Core (such as Linux PIDs, ROS 2 Node names, and DDS network metrics) is processed locally on your machine.
